...
import {validateAge,validateEmail,validateFacebookUrl,validateFullName,validateLineId,validateNickname} from '../../src/shared/utils/profileForm_util'
import {sanitizeValue} from '../../src/shared/utils/sanitizeValue'
import {convertBase64ToFile} from '../../src/shared/utils/file.util'
import {fetchUserProfile,updateUserProfile} from '../../src/services/userServices'
import {fetchDestinations,fetchTravelStyles} from './../../src/services/destination_travelStyles_servicesServices'
  ...
  const fetchInitialData = useCallback(async () => {
    ...
    try {
      ...
      const [destinationsResponse, travelStylesResponse] = await Promise.all([
        fetchDestinations(),fetchTravelStyles()
      ]);

      // Set destinations
      setDestinations(destinationsResponse|| []);

      setCategories(travelStylesResponse || []);
